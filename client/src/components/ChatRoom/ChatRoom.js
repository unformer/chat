...
// hooks
import { useChat, useStream } from 'hooks'
// components
...
export function ChatRoom() {
  ...
  const { startStopVideo } = useStream(roomId)
  ...
  return (
    <Container>
      ...
      <MessageForm username={currentUserName} sendMessage={sendMessage} startStopVideo={startStopVideo} />
